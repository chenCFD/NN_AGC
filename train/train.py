import argparse
from nn_agc_dataset import agc_dataset #, collate
...
feature_dir = '../feature/dataset/'

def main(args):
    tr_dataset = agc_dataset(stage='train', feature_dir=feature_dir)
    tr_dataloader = DataLoader(tr_dataset, batch_size = args.batch_size, shuffle=True, num_workers = args.num_workers)
    cv_dataset = agc_dataset(stage='valid', feature_dir=feature_dir)
