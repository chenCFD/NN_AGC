...
class AGC_STFT_GRU(nn.Module):
    ...
    def forward(self, distorted, x):
        # print('distorted shape: ', distorted.shape)
...
if __name__=='__main__':
    a = torch.randn(1, 414698)
    AGC = AGC_STFT_GRU(480, 10, 480, 240)
    estimate, _ = AGC(a)
    print(estimate.shape)
    
    macs, params = get_model_complexity_info(AGC, (1, 414698), print_per_layer_stat=True)
